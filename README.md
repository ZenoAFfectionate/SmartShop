...
| REINFORCE++ | 92.5% | 34.0% | 0.670064 | 0.384583 |
| CISPO | 86.0% | 39.0% | 0.652138 | 0.423274 |

> 五个算法变体（GRPO / Dr.GRPO / GSPO / REINFORCE++ / CISPO）的严格成功率差异（33.5%–39.0%，CISPO 名义最高）处于评测噪声范围内（CI ±3.3pt），**RL 本身才是 +15pt 的来源**。
...
| REINFORCE++ | 92.5% | 34.0% | 0.670064 | 0.384583 | 0.955000 | 0.719292 | 0.432500 | 0.800000 | 95.5% | 42.5% | 4.5% | 9.9 |
| CISPO | 86.0% | 39.0% | 0.652138 | 0.423274 | 0.865000 | 0.686244 | 0.458333 | 0.755000 | 86.5% | 47.5% | 13.5% | 16.9 |
...
| 算法对照 | 在同一 SFT checkpoint 上额外训练 Dr.GRPO（去除 advantage 的 std 归一化）、GSPO、REINFORCE++、CISPO 四个变体（各 100 rollout），用于对比算法效率与效果。 |
| 最终评测 | 在 `official_test_200` 上对 Base、SFT 及五个 RL 算法 checkpoint 各做 200 次单样本 rollout（解码：sampling, T=1.0, k=1）；结果见上表。 |
